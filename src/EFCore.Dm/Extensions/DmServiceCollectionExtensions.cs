    ...
    public static class DmServiceCollectionExtensions
    {
        public static IServiceCollection AddEntityFrameworkDm([NotNull] this IServiceCollection serviceCollection)
        {
            ...
            (new EntityFrameworkRelationalServicesBuilder(serviceCollection))
                .TryAdd<LoggingDefinitions, DmLoggingDefinitions>()
                .TryAdd<IDatabaseProvider, DatabaseProvider<DmOptionsExtension>>()
                .TryAdd<IRelationalAnnotationProvider, DmAnnotationProvider>()
                .TryAdd(p => (IValueGeneratorCache)p.GetService<IDmValueGeneratorCache>())
                ...
                .TryAdd<IUpdateSqlGenerator>(p => p.GetService<IDmUpdateSqlGenerator>())
                ...
                .TryAdd<IRelationalConnection>(p => p.GetService<IDmRelationalConnection>())
                ...
                {
                    b.TryAddSingleton<IDmValueGeneratorCache, DmValueGeneratorCache>()
                    .TryAddSingleton<IDmUpdateSqlGenerator, DmUpdateSqlGenerator>()
                    .TryAddSingleton<IDmSequenceValueGeneratorFactory, DmSequenceValueGeneratorFactory>()
