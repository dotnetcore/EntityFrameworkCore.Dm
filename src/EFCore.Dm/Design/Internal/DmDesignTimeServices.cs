	...
	public class DmDesignTimeServices : IDesignTimeServices
	{
		public virtual void ConfigureDesignTimeServices(IServiceCollection serviceCollection)
		{
			...
			(new EntityFrameworkRelationalDesignServicesBuilder(serviceCollection))
				.TryAdd<IAnnotationCodeGenerator, DmAnnotationCodeGenerator>()
				.TryAdd<IDatabaseModelFactory, DmDatabaseModelFactory>()
				.TryAdd<IProviderConfigurationCodeGenerator, DmCodeGenerator>()
				.TryAddCoreServices();
		}
	}
}
