...
namespace Microsoft.EntityFrameworkCore.Dm.Query.Internal
{
    public class DmDateDiffFunctionsTranslator : IMethodCallTranslator
    {
        ...
        public virtual SqlExpression Translate(SqlExpression instance, MethodInfo method, IReadOnlyList<SqlExpression> arguments, IDiagnosticsLogger<DbLoggerCategory.Query> logger)
        {
            ...
            {
                SqlExpression startExpr = arguments[1];
                SqlExpression endExpr = arguments[2];
                RelationalTypeMapping typeMapping = ExpressionExtensions.InferTypeMapping(new SqlExpression[] { startExpr, endExpr });
                startExpr = _sqlExpressionFactory.ApplyTypeMapping(startExpr, typeMapping);
                endExpr = _sqlExpressionFactory.ApplyTypeMapping(endExpr, typeMapping);
                return _sqlExpressionFactory.Function("DATEDIFF", new SqlExpression[]
                {
                    _sqlExpressionFactory.Fragment(value),
                    startExpr,
                    endExpr
                }, true, new bool[3] { false, true, true }, typeof(int), null);
            }
            return null;
        }
    }
